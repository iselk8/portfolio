          ...
          <div className="flex w-full items-start justify-between md:flex-col">
            ...
            <div className="flex w-1/2 flex-col items-center self-center lg:w-full lg:text-center mt-2">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:!text-xs">
                I'm a junior software engineer always eager to learn and level
                up my skills. I love turning cool ideas into stuff people can
                actually use. If you're curious about me, want my resume, or
                just feel like checking out the cool stuff I've been working on,
