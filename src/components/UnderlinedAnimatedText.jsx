...
const UnderlinedAnimatedText = ({ text, underlined, className = "" }) => {
  return (
    <div
    ...
    >
      ...
      text-8xl font-semibold w-full capitalize  ${className} xl:text-6xl`}
        variants={quote}
        initial="hidden"
        animate="visible"
      >
...
export default UnderlinedAnimatedText;
